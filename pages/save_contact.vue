<template>
    <div style="padding: 0 1rem;">
        ...
        <form @submit.prevent>
            ...
            <button type="button" @click="handle_add_another">+ Add another number</button>
...
<script setup>
    ...
    const new_contact = reactive({...empty_contact})
    ...
    const handle_select_group = (e, form) => {
        if(form === 'first') new_contact.numbers[0].number_groups = [e.target.value]
        if(form === 'second') new_contact.numbers[1].number_groups = [e.target.value]
    }
