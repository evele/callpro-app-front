...
<script setup lang="ts">
    ...
    const props = defineProps({
        totalContactsNumber: { type: [Number, null], required: true },
        totalGroupsNumber: { type: [Number, null], required: true },
        totalDncNumber: { type: [Number, null], required: true },
    })

    const OPTIONS = computed(() => [
        { id: CONTACT, text: "Contacts", count: props.totalContactsNumber, icon: ContactsSVG, iconColor: "#4F378B" },
        { id: NEW_GROUP, text: "Groups", count: props.totalGroupsNumber, icon: GroupsSVG, iconColor: "#009951" },
        { id: DNC, text: "DNC", count: props.totalDncNumber, icon: DncSVG, iconColor: "#E5A000" },
    ])
