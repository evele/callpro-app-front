<template>
    <div class="bg-white rounded-2xl w-full min-h-[700px] shadow-lg p-6">
        <div class="flex items-center gap-4">
            <Button type="button" class="text-dark-3 bg-transparent rounded-full p-0 w-6 h-6 shadow-md border-grey-14 hover:bg-gray-200" @click="emit('update:sectionToShow', B_MAIN)">
